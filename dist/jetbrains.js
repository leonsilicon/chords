...
// node_modules/.pnpm/nano-spawn-compat@2.0.3/node_modules/nano-spawn-compat/source/context.js
...
// node_modules/.pnpm/nano-spawn-compat@2.0.3/node_modules/nano-spawn-compat/source/options.js
...
// node_modules/.pnpm/nano-spawn-compat@2.0.3/node_modules/nano-spawn-compat/source/spawn.js
import { spawn } from "node:child_process";

// node_modules/.pnpm/nano-spawn-compat@2.0.3/node_modules/nano-spawn-compat/source/once.js
...
// node_modules/.pnpm/nano-spawn-compat@2.0.3/node_modules/nano-spawn-compat/source/windows.js
...
// node_modules/.pnpm/nano-spawn-compat@2.0.3/node_modules/nano-spawn-compat/source/result.js
...
// node_modules/.pnpm/nano-spawn-compat@2.0.3/node_modules/nano-spawn-compat/source/pipe.js
...
// node_modules/.pnpm/nano-spawn-compat@2.0.3/node_modules/nano-spawn-compat/source/iterable.js
...
// node_modules/.pnpm/nano-spawn-compat@2.0.3/node_modules/nano-spawn-compat/source/index.js
...
var buildJetbrainsHandler = function buildJetbrainsHandler(meta, ideBinPath) {
  return async function action(commandId) {
    ...
    const scriptPath = path3.join(tmp, `jetbrains_action_${id}.groovy`);
    const resultPath = path3.join(tmp, `jetbrains_action_${id}.txt`);
    const script = import_outdent.outdent`
    ...
    await spawn2(ideBinPath, ["ideScript", scriptPath]);
    const result = fs2.readFileSync(resultPath, "utf8");
    fs2.rmSync(scriptPath);
    fs2.rmSync(resultPath);
    return result == "1";
  };
};
export {
